...
class AccountUserManager(BaseUserManager):
    ...
    def create_superuser(self, member_id, organization, password=None):
        user = self.create_user(
            member_id=member_id, organization=organization, password=password
        )
        user.is_admin = True
...
#사진 넣는거 있어야한다
    ...
    def profile_image_url(self):
        if self.profile_image and hasattr(self.profile_image, "url"):
            ...
            # 기본 이미지 URL 반환
            return "https://mblogthumb-phinf.pstatic.net/MjAyMDExMDFfMTgy/MDAxNjA0MjI4ODc1NDMw.Ex906Mv9nnPEZGCh4SREknadZvzMO8LyDzGOHMKPdwAg.ZAmE6pU5lhEdeOUsPdxg8-gOuZrq_ipJ5VhqaViubI4g.JPEG.gambasg/%EC%9C%A0%ED%8A%9C%EB%B8%8C_%EA%B8%B0%EB%B3%B8%ED%94%84%EB%A1%9C%ED%95%84_%ED%95%98%EB%8A%98%EC%83%89.jpg?type=w800"
